...
export const line: MarkCompiler = {
  ...
  encodeEntry: (model: UnitModel) => {
    ...
    e.x = ref.stackable(X, model.encoding.x, model.scaleName(X), model.getScale(X), model.stack, 'base');
    e.y = ref.stackable(Y, model.encoding.y, model.scaleName(Y), model.getScale(Y), model.stack, 'base');
